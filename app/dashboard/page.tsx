      ...
      <div className="mx-auto w-full max-w-2xl px-5 py-8 sm:px-8">
        <header className="mb-8 rounded-2xl border border-border/70 bg-card/80 px-4 py-3 backdrop-blur-sm">
          <div className="flex items-center justify-between gap-3">
            ...
            <Link href="/" className="flex size-9 items-center justify-center rounded-xl bg-secondary text-secondary-foreground transition-colors hover:bg-secondary/70" aria-label="Back to home">
